...
$schoolsql = mysqli_query($conn,"SELECT * from school where SId in (SELECT SId from student where PId='$pid') ");
$school = mysqli_fetch_assoc($schoolsql);
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="parentindex.php">Dashboard</a>&nbsp;/&nbsp;<a href="#">School Information</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content mt-3">
                    ...
                    <form action="parentindex.php" method="post" style="margin-top: 20px;height: 650px;">
                    <div class="morecarinfo"  style="height: 600px;box-shadow: -1px 0px 18px 2px rgba(0,0,0,0.75);border-radius: 10px;">
