                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="owner.php">Dashboard&nbsp;/&nbsp;</a><a href="#">Student's Salary</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="carlist">
                                        ...
                                        <div class="carcontent">
                                            ...
                                            <div class="rght">
                                                    ...
                                                    <a href="showsalaryfromcar.php?sid=<?php echo $row['SId']?>"><?php echo $row['SName']?></a>
                                            </div>
