...
getlocation() is the function that the location of school bus getting whenever it changed
...
<body onload="initialize_map();">
    ...
    <input type="button" class="btn" value="back"  style="margin-right:150px">
    <a>
