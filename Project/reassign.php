...
<body>
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <div class="page-title">
                                ...
                                <li class="active"><a href="owner.php">Dashboard</a>&nbsp;/&nbsp;<a href="assign.php">Assign&Reassign</a>&nbsp;/&nbsp;<a href="#">Reassign</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <h2 style="height: 70px;" class=" bg-white" > 
                <a href="assign.php"  class=" text-left" style="color:gold;" >
                <i class="fa fa-arrow-circle-left" style="font-size: 50px;padding: 10px;"></i><a></i>
                <i class="fa fa-info-circle" style="font-size: 20px;padding: 10px; padding-left: 250px;">&nbsp;&nbsp;&nbsp;Can remove process information as you want.</i></h2>

                      <table class="table table-hover  border-top text-left bg-white">
                 
                    <tr style="font-size: 25px;height:60px;color:black;background-color:gold;"  >
               ...
               <?php
                ...
                else
                {
                    $oname="";
                            ...
                            $btn='<i class="fa fa-trash" aria-hidden="true" style="font-size:24px;"></i>';

                            echo '<tr class="text-danger" style="font-size: 16px;height:50px;">';
                            ...
                            echo '<td>'.$oname.'</td>'; 
                             ...
                             echo '<td>'.$sname.'</td>';
                              echo '<td>'.$stype.'</td>'; 
                            echo '<td class="text-center"><a href="assignconfig.php?aid='.$aid.'" class="text-danger">'.$btn.'</a></td> </tr>'; 
                        $count++; 
                }
                ...
                {
                     echo '<h2 style="height: 70px;width:1000px;margin-left:200px;margin-top:30px;border: 1px solid grey;" class=" bg-white" > 
                <a href="assign.php"  class="text-left" style="color:gold;">
                <i class="fa fa-arrow-circle-left" style="font-size: 50px;padding:10px;"></i><a></i>
                <i class="fa fa-info-circle" style="font-size: 20px;padding-left: 100px;padding: 5px;">&nbsp;&nbsp;&nbsp;There is no assignment.So,you do not have anything to remove.Please assign First!</i></h2>';
                }
