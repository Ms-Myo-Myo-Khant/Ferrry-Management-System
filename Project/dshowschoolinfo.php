...
$_SESSION['sname']=$_POST['hiddenschoolinfo'];
$sname=$_SESSION['sname'];

$school=mysqli_query($conn,"SELECT * from school where SName='$sname' ");
...
<script>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="driver.php">Dashboard</a>&nbsp;/&nbsp;<a href="dschoolinfo.php">School Information</a>&nbsp;/&nbsp;<a href="#">Show School Information</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content mt-3">
                    ...
                    <form action="dschoolinfo.php" method="post"  style="height: 680px;">
                    <div class="morecarinfo"  style="margin-top:10px;height: 650px;">
                        <div style="width: 100%;height:600px;margin:0px auto;margin-bottom:60px;"  class="showcar">
                                ...
                                <div class="buttoncar">      
                                        ...
                                        <?php $sname=$row1['SName'] ?>   
                                        <input type="hidden" name="hiddendriverid" value="<?php echo $did ?>">   
                                        <input type="hidden" name="hiddenschoolinfo" value="<?php echo $sname ?>">
                                </div>
