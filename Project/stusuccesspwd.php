...
<h2><a href="studentlist.php"> <i class="fa fa-arrow-circle-left" style="font-size: 50px;padding: 10px;color: gold;padding-right: 30px;"></i><a><span style="color: gold">Register successfully</span></i></h2>
...
function bsend()
{
        ...
        echo '<div class="errtext">You have to send password for your student\'s parent  login.</div>';
        ...
        $name=$_SESSION['name']; 
         	include("confs/config.php"); 
        		 if(!mysqli_query($conn,"UPDATE student set PPassword='$password' where Email='$email'"))
        		{
        		...
        		else
        			{
                        ...
                        <br/>Recently you  was registered as a student\'s parent in FMS.
        				...
        				echo '<div class="errtext">Password is successfully sent to your student\'s parent.</div>';
        			}	
