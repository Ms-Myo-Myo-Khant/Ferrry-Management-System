        ...
        <div class="user-area dropdown float-right">
            ...
            <div class="user-menu dropdown-menu">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="driver.php">Dashboard&nbsp;/&nbsp;</a><a href="dstudentsalary.php">Student's Salary&nbsp;</a>/&nbsp;<a href="#">Show Salary From Car</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content mt-3">
                    ...
                    <?php while($row=mysqli_fetch_assoc($carsql)):
                        $cid = $row['CId'];
                        $assignsql=mysqli_query($conn,"SELECT * from assign where DId='$did'and SId='$sid'");
                    ?>

                        <?php while($noofassign=mysqli_fetch_assoc($assignsql)): ?>
                                ...
                                <div class="carlist">
                                        ...
                                        <div class="carcontent">
                                            ...
                                            <div class="rght">
                                                 ...
                                                 <a href="dsalarylist.php?subid=<?php $_SESSION['subid']=$noofassign['SubId'];
                                                   $_SESSION['sid']  =$noofassign['SId']; echo $noofassign['SubId']?>&sid=<?php echo $noofassign['SId']?>">
                                                    <?php 
                                                    echo $row['Model']; 
                                                    echo " ( ";
                                                    echo $noofassign['SType'];
                                                    echo " )";
                                                    $_SESSION['subid']= $noofassign['SubId'];
                                                  ?></a>
                                            </div>
