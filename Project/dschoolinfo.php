...
$school=mysqli_query($conn,"SELECT * from school where SId in (SELECT SId from assign where DId='$did') ");

$assignsql = mysqli_query($conn, "SELECT * from assign where DId='$did' ");
$assign = mysqli_fetch_assoc($assignsql);
//$car=mysqli_query($conn,"SELECT * from car where did='$did'");
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="driver.php">Dashboard</a>&nbsp;/&nbsp;<a href="dschoolinfo.php">School Information</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <?php while($row=mysqli_fetch_assoc($school)):?>
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-6 setcarcov animated zoomIn">
                        <form method="post" action="dshowschoolinfo.php">                  
                                ...
                                <div class="carlist">
                                        ...
                                        <div class="carbg">
                                            ...
                                            <img src="images/carbg/<?php $random = 1; echo $random; ?>.jpg" style="width: 320px;height: 150px;">
                                        ...
                                        <div class="carcontent">
                                            ...
                                            <div class="rght">   
                                                    ...
                                                    <button><?php echo $row['SName']?></button>
                                            </div>
