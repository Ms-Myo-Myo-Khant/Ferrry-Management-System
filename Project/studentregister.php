...
$school = mysqli_query($conn,"SELECT * from school where     in (SELECT SId from assign where Id='$ownerid') ");
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="owner.php">Dashboard/</a><a href="#">Student Register</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-6 setcarcov  animated zoomIn">
                                ...
                                <div class="carlist">
                                        ...
                                        <div class="carcontent">
                                            ...
                                            <div class="rght">
                                                    <input type="hidden" name="carinformation" value="<?php echo $row['SId']; ?>">
                                                    <a href="registercar.php?sid=<?php echo $row['SId']?>"><?php echo $row['SName']?></a>
                                            </div>
