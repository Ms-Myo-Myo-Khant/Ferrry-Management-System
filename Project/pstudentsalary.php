    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="parentindex.php">Dashboard&nbsp;/&nbsp;</a><a href="#">Salary</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content mt-3" style="overflow-y: hidden;">
                    ...
                    <div class="col-sm-12 col-lg-12 col-md-12 slrtitle animated fadeInDown">
                        <h6>Salary(Current)</h6>
                    </div>

                    
                    <div class="parslr col-sm-12 col-lg-4 col-md-6 animated fadeInUp">
                        
                        <div class="currentslr">
                            <div class="curslrimg">
                                <img src="images/project/salary.jpg" alt="Salary">
                            </div>

                            <div class="curslrtxt">
                                <a href="pshowcurrentsalary.php?stuid=<?php echo $srowprofile['StuId']; 

                                $_SESSION['stuid']=$srowprofile['StuId'];

                                ?>"><p>Salary(<span class="curtxt">Current</span>)</p></a>
                            </div>
                        </div>
                    ...
                    <div class="parslr col-sm-12 col-lg-4 col-md-6 animated fadeInUp">
                            ...
                            <div class="curslrtxt">
                                <a href="pshowprevioussalary.php?stuid=<?php echo $srowprofile['StuId'];

                                $_SESSION['stuid']=$srowprofile['StuId'];

                                ?>"><p>Salary(<span class="pretxt">Previous</span>)</p>    </a>
                            </div>
