...
//$car=mysqli_query($conn,"SELECT * from carinfo where did='$pid'");

//$count=mysqli_num_rows($car);
//$row=mysqli_fetch_assoc($car);
//$driver=mysqli_query($conn,"SELECT * from driverinfo where did='$pid'");
...
<aside id="left-panel" class="left-panel">
        ...
        <div class="navbar-header">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <form class="hovform" method="post" action="psitehome.php">
    ...
    <div id="inline" class="profile lity-hide">
                ...
                <form method="post" action="editprofileforparent.php">
                <div class="hideprofiletable">
                        ...
                        <table>
                                <tr>
                                    ...
                                    <td>
                                    <input type="text" name="name" value="<?php echo $prowprofile['PName']?>" class="inputprofile">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="text" name="phone" value="<?php echo $srowprofile['PhoneNo']?>" class="inputprofile">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="text" name="address" value="<?php echo $srowprofile['Address']?>" class="inputprofile">
                                    </td>
                                </tr>
            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <li class="active"><a href="parentindex.php">Dashboard</a>&nbsp;/&nbsp;<a href="#">Site Home</a></li>
                        </ol>
                    </div>
                </div>
            </div>
