...
// $school=mysqli_query($conn,"SELECT * from schoolinfo");
// $row1=mysqli_fetch_assoc($school);
$MONTH="January";
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="parentindex.php">Dashboard&nbsp;/&nbsp;</a><a href="pstudentsalary.php">Salary</a>&nbsp;/&nbsp;<a href="#">Show Previous Salary</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content mt-3" style="overflow-y: hidden;">
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4 animated fadeInUp">                        
                        <div class="dropdownmonthslr">
                            <ul>
                                ...
                                <ul class="liul2" onchange="test()" id='year'>
                                    <li><a href="pchooseyearforprevious.php?year=2019"  style="color: white;">2019</a></li>
                                    <li><a href="pchooseyearforprevious.php?year=2020"  style="color: white;">2020</a></li>
                                    <li><a href="pchooseyearforprevious.php?year=2021"  style="color: white;">2021</a></li>
                        ...
                        <div class="dropdownmonthslr">
                            <ul>
                                ...
                                <ul class="liul">
                                    <li><a href="pchoosemonthforprevious.php?month=January" style="color: white;">January</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=February"  style="color: white;">February</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=March"  style="color: white;">March</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=April"  style="color: white;">April</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=May"  style="color: white;">May</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=June"  style="color: white;">June</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=July"  style="color: white;">July</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=August"  style="color: white;">August</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=September"  style="color: white;">September</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=October"  style="color: white;">October</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=November"  style="color: white;">November</a></li>
                                    <li><a href="pchoosemonthforprevious.php?month=December"  style="color: white;">December</a></li>                                    
                                </ul>
                            </ul>
                        </div>
                    ...
                    <div class="col-sm-12 col-lg-8 col-md-8 animated fadeInUp"  style="height: 600px;">
