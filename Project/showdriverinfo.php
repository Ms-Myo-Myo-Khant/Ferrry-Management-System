...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="owner.php">Dashboard</a>&nbsp;/&nbsp;<a href="driverinfo.php">Driver Information</a>&nbsp;/&nbsp;<a href="#">Show Driver Information</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content mt-3">
                                            ...
                                            <form action="driverinfo.php" method="post" style="margin-top:20px;height: 830px;">
                                                <div class="morecarinfo" style="height: 800px;">
                                                    <div style="width: 100%;height: 750px;margin:0px auto;margin-bottom:60px;"  class="showcar">
                                                            

                                                            <div class="showcarinfocontent" style="border-radius: 10px;">
