...
$carsql = mysqli_query($conn,"SELECT * from car where CId in (SELECT CId from assign where DId='$did') ");
$assignsql=mysqli_query($conn,"SELECT * from assign where DId='$did'and SId='$sid'");
$assignsq = mysqli_query($conn, "SELECT * from assign where DId='$did' ");
$assign1 = mysqli_fetch_assoc($assignsq);
...
<script>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li class="active"><a href="driver.php">Dashboard&nbsp;/&nbsp;</a><a href="dmapSchool.php">Choose School For Map&nbsp;</a>/&nbsp;<a href="#">Choose Car For Map</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <?php $car = mysqli_fetch_assoc($carsql) ?>
                    <?php while($assign = mysqli_fetch_assoc($assignsql)): ?>
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-6 setcarcov  animated zoomIn">
                                ...
                                <div class="carlist">
                                        ...
                                        <div class="carbg">
                                            ...
                                            <img src="images/carbg/20.jpg" style="width: 300px;height: 140px;">
                                            <div class="textonimg">Bus</div>
                                        </div>
                                        ...
                                        <div class="carcontent">
                                            ...
                                            <div class="rght">
                                                    <a href="chooseMapType.php?SId=<?php echo $sid?>&CId=<?php echo $assign['CId'] ?>&SubId=<?php echo $assign['SubId']?>">
                                                        <?php 
                                                            echo $car['Model']." ( ".$assign['SType']." )"; 
